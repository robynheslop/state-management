...
const Template = (args) => <ConspiracyList {...args} />;

export const theOneWithDefaultValues = Template.bind({});
theOneWithDefaultValues.args = {};

export const theOneWithASingleConspiracy = Template.bind({});
theOneWithASingleConspiracy.args = {
  conspiracies: [
    {
...
export const theOneWithMultipleConspiracies = Template.bind({});
theOneWithMultipleConspiracies.args = {
  conspiracies: [
    {
      ...
      imageUrl:
        "https://i.imgur.com/VowdLtk.jpeg",
    },
    {
      id: "71607ad7-c37a-4538-b6c7-be932c3ca0d3",
      title: "5G M8",
...
export const theOneWithADeleteHandler = Template.bind({});
theOneWithADeleteHandler.args = {
  conspiracies: [
    {
      id: "71607ad7-c37a-4538-b6c7-be932c3ca0d3",
      title: "5G M8",
  ...
  handleDelete: (id) => console.log('id', id)
};
export default {
  title: "Components/ConspiracyList",
  component: ConspiracyList,
};
